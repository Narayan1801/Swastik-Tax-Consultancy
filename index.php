			...
			<div class="container">	
				<div class="header-left">
					<ul class="pull-left">
						<li>
							<a href="#">
								<i class="fa fa-phone" aria-hidden="true"></i> +91 9769906875
							</a>
						</li><!--/li-->
						<li>
							<a href="#">
								<i class="fa fa-envelope" aria-hidden="true"></i>swastiktaxconsultant2020@gmail.com
							</a>
						</li><!--/li-->
					</ul><!--/ul-->
				</div><!--/.header-left -->
					...
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="index.html">
								<img src="assets/images/logo/logo.ico" alt="logo" style="height: 70px ; width : 130px">
							</a>
						</div><!--/.navbar-header -->
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="single-slide-item-content">
											<h2>Consult Your <br> Taxation With Us</h2>
											<p>
												We are the unique Consultancy Firm for your Tax solution, That is ready to take challenge and knockout your Tax related problems. 
											</p>
			...
			<div class="container">
				<div class="we-do-details">
					<div class="section-header text-center">
						<h2>what we do</h2>
						<p>
							We Help in making Tax Returns and work closely with our Clients to minimize their Tax Liabilities throughout the Year.
								...
								<div class="single-we-do-box text-center">
									<div class="we-do-description">
										...
										<div class="we-do-comment">
											<p>
												We provide best and expert advice to our clients.
											</p>
										</div><!--/.we-do-comment-->
							...
							<div class="col-sm-4 col-xs-12">
								<div class="single-we-do-box text-center">
									<div class="we-do-description">
										...
										<div class="we-do-comment">
											<p>
												Our Team Helps in the Process of Incorporating a Business
							...
							<div class="col-sm-4 col-xs-12">
								<div class="single-we-do-box text-center">
									<div class="we-do-description">
										...
										<div class="we-do-comment">
											<p>
												Our Professional Accounting Team keeps and interprets financial records of our clients.
						...
						<div class="col-sm-6">
							<div class="single-about-us">
								<div class="about-us-txt">
									<h2>about us</h2>
									<p>
										Swastik holds expertise in Tax law, Tax compliance and Tax planning. We help in making Tax returns and work closely with our Clients to Minimize their Tax Liabilities throughout the year
									</p>
									<div class="project-btn">
										<a href="about.html"  class="project-view">learn more
										</a>
									</div><!--/.project-btn-->
								</div><!--/.about-us-txt-->
							</div><!--/.single-about-us-->
							...
							<div class="row">
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										...
										<div class="service-txt">
											...
											<p>
												We help in Income Tax Return Filing
												</p>
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										...
										<div class="service-txt">
											...
											<p>
												Our Professional Accontancy Team keeps the Track of Accounts of our Clients.
											</p>
											<a href="#" class="service-btn">
												learn more
											</a>
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										...
										<div class="service-txt">
											<h2>
												<a href="#">GST Registeration</a>
											</h2>
											<p>
												GST Registeration And Filing also Managed by our Team
											</p>
											<a href="#" class="service-btn">
												learn more
											</a>
							...
							<div class="row">
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										...
										<div class="service-txt">
											<h2>
												<a href="#">Udyog Adhar</a>
											</h2>
											<p>
												Queries Regarding Udyog Adhar are also Taken Care Of
											</p>
											<a href="#" class="service-btn">
												learn more
											</a>
								...
								<div class="col-sm-4 col-xs-12">
									<div class="service-single text-center">
										...
										<div class="service-txt">
											<h2>
												<a href="#">Shop License</a>
											</h2>
											<p>
												End to end support in the Process of Shop License 
											</p>
											<a href="#" class="service-btn">
												learn more
											</a>
			...
			<div class="container">
				<div class="contact-details">
					<div class="section-header contact-head  text-center">
						<h2>contact us</h2>
						<p>
							Contact us on our Contact number , or Reach out to our Email Address.For more Queries you can also reach out our Office Address 
						</p>
					</div><!--/.section-header-->
									...
									<div class="contact-right">
										<div class="contact-adress">
											<div class="contact-office-address">
												<h3>contact info</h3>
												<p>
													Room No.4, Narayan Apartment, Rambaug,
													Lane no-4 end, Chikanghar, Kalyan West,
													PIN - 421301 
												</p>
												<div class="contact-online-address">
													...
													<div class="single-online-address">
														...
														<span>swastiktaxconsultant2020@gmail.com</span>
													</div><!--/.single-online-address-->
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="hm-footer-widget">
								...
								<div class="hm-foot-para">
									<p>
									We hold expertise in tax law, tax compliance, and tax planning. We help in making tax returns and work closely with our clients to minimize their tax liabilities throughout the year.
